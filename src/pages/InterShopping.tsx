  ...
  return (
    <div className="w-full h-full bg-[#F5F6FA] flex flex-col font-sans relative">
      <div className="bg-white px-4 pt-6 pb-4 flex items-center shadow-sm">
        ...
        <h1 className="text-lg font-bold text-gray-900 ml-2">Inter Shop</h1>
      </div>
      <div className="flex-1 px-5 pt-8 flex flex-col items-center text-center">
        <ShoppingBag className="w-16 h-16 text-[#FF7A00] mb-4" />
        <h2 className="text-xl font-bold text-gray-900 mb-2">Compre com Cashback</h2>
        <p className="text-gray-500">As melhores lojas estão aqui.</p>
      </div>
      <InterBottomNav />
    </div>
  );
