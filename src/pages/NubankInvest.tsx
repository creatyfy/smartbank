  ...
  return (
    <div className="w-full h-full bg-white flex flex-col font-sans">
      ...
      <div className="flex-1 px-5 pt-6">
        <h1 className="text-3xl font-medium text-gray-900 mb-8">Investimentos</h1>
        <div className="bg-gray-100 rounded-xl p-5 flex items-center gap-4 cursor-pointer">
          <TrendingUp className="w-6 h-6 text-gray-900" />
          <span className="font-medium text-gray-900">Conhecer opções</span>
        </div>
      </div>
    </div>
  );
