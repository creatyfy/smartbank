  ...
  return (
    <div className="w-full h-full bg-[#F5F5F5] flex flex-col font-sans relative">
      ...
      <div className="flex-1 px-5 pt-8 flex flex-col items-center text-center">
        <Receipt className="w-16 h-16 text-[#009EE3] mb-4" />
        <h2 className="text-xl font-bold text-gray-900 mb-2">Pagar contas</h2>
        <p className="text-gray-500">Pague boletos e tributos sem sair de casa.</p>
      </div>
      <MPBottomNav />
    </div>
  );
