  ...
  return (
    <div className="w-full h-full bg-[#F5F5F5] flex flex-col font-sans relative">
      <div className="bg-white px-4 pt-6 pb-4 flex items-center shadow-sm">
        ...
        <h1 className="text-lg font-bold text-gray-900 ml-2">Mais opções</h1>
      </div>
      <div className="flex-1 px-5 pt-8 flex flex-col items-center text-center">
        <Menu className="w-16 h-16 text-[#009EE3] mb-4" />
        <h2 className="text-xl font-bold text-gray-900 mb-2">Explore o Mercado Pago</h2>
        <p className="text-gray-500">Todos os serviços em um só lugar.</p>
      </div>
      <MPBottomNav />
    </div>
  );
